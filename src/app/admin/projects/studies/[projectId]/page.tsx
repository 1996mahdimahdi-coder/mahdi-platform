...
export default function AdminCapitalStudyEditPage() {
  ...
  const endpoint = `/api/admin/projects/studies/${encodeURIComponent(projectId)}`;
  ...
  return (
    <AdminShell title="تحرير الدراسة المدفوعة (رأس المال)" subtitle={`مشروع ${projectId}`}>
